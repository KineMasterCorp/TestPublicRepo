...
class VideoDataSource {
    ...
    static func allVideos() -> VideoDataSource {
        return VideoDataSource(videos: [
            VideoDataInfo(title: "화려한 댄스 타임", tags: ["인스타그램", "틱톡"], videoURL: URL(string:"https://cdn-project-feed.kinemasters.com/projects/604e0a7001071402c972bb54/1qp3tI8oOp8eiBGpdiM0xN6nCak.mp4")!,
                          poster: "1t0g4VLxJqxFX1u1U8yxTN4L7kB",
                          category: "예능"),
            VideoDataInfo(title: "다이나믹 오프너 인트로", tags: ["유튜브", "다이나믹", "오프너"], videoURL: URL(string:"https://cdn-project-feed.kinemasters.com/projects/607e526633308402c8b63fc0/1rPx8TVx9fNcxcwjjM6zDDdTuxt.mp4")!,
                          poster: "1t0a4oZlom8FwedLVilXlZLG6n1",
                          category: "인트로"),
            VideoDataInfo(title: "나의 데일리 브이로그", tags: ["유튜브", "데일리", "브이로그"], videoURL: URL(string:"https://cdn-project-feed.kinemasters.com/projects/607e567f33308402c8b63fc4/1rPzGNu3CIVcQcqEQHScyKTnshH.mp4")!,
                          poster: "1t0qsnyl07h9IZYotZouJXdxsG7",
                          category: "브이로그"),
            VideoDataInfo(title: "파이어 타이틀 인트로", tags: ["유튜브", "파이어", "인트로", "불"], videoURL: URL(string:"https://cdn-project-feed.kinemasters.com/projects/604e989401071402c972bb65/1r3AYIKlxjmaJKtFxykImA9Tkie.mp4")!,
                          poster: "1t0ayTcLUScBNHuM4YkZ9viSt9T",
                          category: "인트로"),
            VideoDataInfo(title: "푹발 텍스트 인트로", tags: ["폭발", "인트로", "유튜브"], videoURL: URL(string:"https://cdn-project-feed.kinemasters.com/projects/604e9b8901071402c972bb6b/1qp4oijCYMOCXjfvbpUozeA9Olc.mp4")!,
                          poster: "1t0bCGMCoJkHQfnbUHYUCT7klhV",
                          category: "인트로"),
            VideoDataInfo(title: "베스트 포토", tags: ["인스타그램", "릴스", "포토"], videoURL: URL(string:"https://cdn-project-feed.kinemasters.com/projects/604e0aa901071402c972bb55/1qp3wZhJx4uHIl6HOHiy2q2BxWs.mp4")!,
                          poster: "1t0bloCu0cPacKyhpuVc9vbKg9c",
                          category: "비트"),
            VideoDataInfo(title: "시네마틱 필름", tags: ["유튜브", "인트로", "브이로그"], videoURL: URL(string:"https://cdn-project-feed.kinemasters.com/projects/604df5ea01071402c972bb47/1qp3I3kW1RFraa5kiQsHVyuT2Oj.mp4")!,
                          poster: "1t0c2yZXFYzqqLhDkV99iLEwo0h",
                          category: "브이로그"),
            VideoDataInfo(title: "구독 인트로", tags: ["유튜브", "구독", "인트로"], videoURL: URL(string:"https://cdn-project-feed.kinemasters.com/projects/604df2e101071402c972bb3a/1qp2CYdoGVtvgYzwSF0itEIlfe8.mp4")!,
                          poster: "1t0cdAR1RFAcXUGo25nj39XcVgT",
                          category: "인트로"),
            VideoDataInfo(title: "시간 여행", tags: ["인스타그램", "릴스", "여행", "시간"], videoURL: URL(string:"https://cdn-project-feed.kinemasters.com/projects/604df20401071402c972bb36/1qp1mvB8gezs2Vqf6QGc1yi22wH.mp4")!,
                          poster: "1t0d50MULbNM4WNFaEbOb2oolzT",
                          category: "비트"),
            VideoDataInfo(title: "오늘의 점심 메뉴는?", tags: ["인스타그램", "점심", "메뉴"], videoURL: URL(string:"https://cdn-project-feed.kinemasters.com/projects/607e58d533308402c8b63fc7/1rQ0TVnD5Lb0JZaZSjYqYY4gFBG.mp4")!,
